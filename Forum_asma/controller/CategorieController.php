        ...
        public function listCategories(){
            ...
            return [
                ...
                "data" => [
                    ...
                    //la méthode "findAll" est une méthode générique qui provient de l'AbstractController (dont hérite chaque controller de l'application, il ne faut pas la modifier)
                    //Seuls sont à modifier les attributs dans le tableau en fonction des besoins.
                ]
            ];   
        }
    }